...
## Persona 1
  ...
  Suas principais necessidades são:
    ...
    * 📖 *Encontrar livros e materiais de estudo* para sua formação;
    * 💰 *Buscar opções mais acessíveis* para adquirir esses materiais;
    * 📍 *Localizar sebos e pontos de troca e doação*;
    * ♻️ *Destinar livros que não utiliza mais* por meio de troca ou doação.

  Para Mariana, reunir essas informações em um único espaço facilita tanto a busca por novos materiais quanto o compartilhamento dos livros que já possui.

  Ela é uma usuária que busca acesso, economia e praticidade, contribuindo para direcionar a solução às necessidades de troca, doação e circulação de livros
